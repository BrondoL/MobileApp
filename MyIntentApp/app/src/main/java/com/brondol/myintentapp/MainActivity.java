package com.brondol.myintentapp;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "BrondoL");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 20);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Aulia Ahmad Nabil");
                mPerson.setAge(20);
                mPerson.setEmail("Aulia.ahmad1074@students.unila.ac.id");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "082297578773";
